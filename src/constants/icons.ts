...
export const ICON_PATHS: Record<string, string> = {
  ...
  // 分类管理：三角 / 方块 / 圆三形状（类目归组隐喻）
  category: 'M12 3L6.8 11h10.4L12 3zM4 13h7v7H4zM17.5 13a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7z',
  ...
  // 勋章管理：缎带 + 奖章 + 星（超管专属）
  medal: 'M9 3l1.5 6h-3L9 3zM15 3l-1.5 6h3L15 3zM12 9a6 6 0 1 0 0 12 6 6 0 0 0 0-12zm0 3l1.1 2.3 2.6.3-1.9 1.8.5 2.6L12 17.2l-2.3 1.1.5-2.6L8.3 14.9l2.6-.3z',
}
